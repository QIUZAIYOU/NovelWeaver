      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div className="relative pl-8">
            ...
            {memories.map((mem) => (
              <div key={mem.id} data-entity-id={mem.id} className="relative mb-4 group">
                {/* 时间轴节点 */}
                <div
                  className={`absolute left-[-20px] top-4 w-3 h-3 rounded-full border-2 border-[#0a0a0a] ${getImportanceColor(mem.importance) === "text-red-500" ? "bg-red-500" : getImportanceColor(mem.importance) === "text-orange-500" ? "bg-orange-500" : "bg-muted-foreground/50"}`}
                />
